...
# Задача
Используя Ansible, автоматизировать установку nginx со статическим сайтом и создать пользователя deploy с доступом по ключу и sudo без пароля.
...
TASK [Create directory for static site] ********************************************************************************
ok: [localhost]

TASK [Unarchive static website] ****************************************************************************************
changed: [localhost]

TASK [Install nginx vhost config] **************************************************************************************
changed: [localhost]
